...
Component({
  ...
  methods: {
    ...
    create: function () {
      wx.navigateTo({
        url: '../../pages/create_publishing/create_publishing'
      })
      this.showOrHide()
    ...
    popp: function () {
     ...
     animationDelLots.translate(0, -200 / 750 * systemInfo.windowWidth).rotateZ(0).opacity(1).step();
      animationAdd.translate(0, -320 / 750 * systemInfo.windowWidth).rotateZ(0).opacity(1).step();
      this.setData({
